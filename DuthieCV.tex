...
%\end{itemize}
\begin{itemize}
	\item{\bf ERC Postdoctoral Research Fellow}, Nov. 2016 -- present \\%Oct. 2017 \\
	Biological and Environmental Sciences, University of Stirling
\end{itemize}
\begin{itemize}
...
\begin{etaremune}
%\item Cusack, J. J., {\bf A. B. Duthie}, O. S. Rakotonarivo, R. A. Pozo, T. H. E. Mason, J. M\r{a}nsson, L. Nilsson, R. McKenzie, I. M. Tombre, E. Eyth\'{o}rsson, J. Madsen, A. Tulloch, G. Churchill, J. Shaw, R. D. Hearn, S. Redpath, and N. Bunnefeld. Short and long-term synchrony between changes in conflict management effort and increasing large grazing bird populations in northern Europe. {\it In prep}
%\item {\bf Duthie, A. B.}, J. J. Cusack, E. B. Nilsen, R. A. Pozo, O. S. Rakotonarivo, B. Van Moorter, and N. Bunnefeld. GMSE: an R package for generalised management strategy evaluation. {\it Methods in Ecology and Evolution}. {\it In prep}.
...
%\item Paine, C. E. T., A. Deasey, and {\bf A. B. Duthie}. Towards general mechanistic predictions of community dynamics. {\it Functional Ecology}. {\it Submitted}.
\item {\bf Duthie, A. B.}, G. Bocedi, R. R. Germain, and J. M. Reid. 2017. Evolution of pre-copulatory and post-copulatory strategies of inbreeding avoidance and associated polyandry. {\it Journal of Evolutionary Biology}. {\it In press}. \href{https://www.biorxiv.org/content/early/2017/09/24/136093}{DOI: 10.1101/136093}
