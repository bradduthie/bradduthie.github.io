...
\begin{etaremune}
\item {\bf Duthie, A. B.}, G. Bocedi, R. R. Germain, and J. M. Reid. Evolution Of pre-copulatory and post-copulatory strategies of inbreeding avoidance and associated polyandry. {\it Journal of Evolutionary Biology}. {\it In revision}. \href{http://biorxiv.org/content/early/2017/05/09/136093}{DOI: 10.1101/136093}
...
\begin{itemize}
\item Leverhulme Trust Early Career Fellowship (2017) -- 70,434 GBP
...
\section*{Leadership}
\begin{itemize}
\item Reviewer for {\it Acta Oecologica}, {\it American Naturalist}, {\it Arthropod-Plant Interactions}, {\it Behavioral Ecology and Sociobiology}, {\it Biology Letters}, {\it BMC Evolutionary Biology}, the {\it Journal of Animal Ecology}, the {\it Journal of Theoretical Biology} (3), {\it Landscape Ecology}, {\it Oikos}, {\it Proceedings of the Royal Society B}, and {\it Symbiosis} % {\it Evolution},
...
\begin{etaremune}
\item 2017. {\bf GMSE} {\it v0.2.2.7}. Generalised Management Strategy Evaluation Simulator. {\it Written in R and C.} \\
R package link: \href{http://CRAN.R-project.org/package=GMSE}{< http://CRAN.R-project.org/package=GMSE >}
\item 2017. {\bf gamesGA} {\it v1.1.3.2}. Genetic Algorithm for Sequential Symmetric Games. {\it Written in R and C.} \\
