...
\item {\bf Duthie, A. B.}, A. M. Lee, and J. M. Reid. Inbreeding parents should invest more resources in fewer offspring. {\it In prep}. \href{http://biorxiv.org/content/early/2016/07/08/062794}{http://dx.doi.org/10.1101/062794}
\item {\bf Duthie, A. B.}, and J. M. Reid. Evolution of inbreeding avoidance and inbreeding preference through mate choice among interacting relatives. {\it American Naturalist}. {\it Accepted}.
\item {\bf Duthie, A. B.}, G. Bocedi, and J. M. Reid. When does female multiple mating evolve to adjust inbreeding? Effects of inbreeding depression, direct costs, mating constraints, and polyandry as a threshold trait. {\it Evolution}. {\it Accepted}.
...
\item Frater, P. N., and {\bf A. B. Duthie}. 2016. Power scaling, vascular branching patterns, and the golden ratio. {\it Ideas in Ecology and Evolution}. 9: 15-18. DOI: 10.4033/iee.2016.9.4.n
...
%\item Gilman, R. T., K. C. Abott, and {\bf A. B. Duthie}. The evolution of increased biodiversity maintained by the storage effect. {\it Proceedings of the Royal Society B}. {\it In prep}.
...
\section*{Leadership}
\begin{itemize}
\item Reviewer for {\it Acta Oecologica}, {\it American Naturalist}, {\it Arthropod-Plant Interactions}, {\it Behavioral Ecology and Sociobiology}, {\it Biology Letters}, and {\it BMC Evolutionary Biology} (2)
