...
\item Jones, I. L., A. Timoshenko, I. Zuban, K. Zhadan, J. J. Cusack, {\bf A. B. Duthie}, I. D. Hodgson, J. Minderman, R. A. Pozo, R. C. Whytock, N. Bunnefeld. 2022. Achieving international biodiversity targets: learning from migratory waterfowl management. {\it Journal of Applied Ecology}. {\it Accepted}.
...
\begin{itemize}
\item {\bf Undergraduate researchers}. 15 Students (2010-2022) %Cody Duncan (2010), Megan Stoner (2010-2011), Elizabeth Howe (2011), Christina Pacholec (2011), Ethan Van Helten (2011), Christine Lim (2011-2012), Aisha Azhar (2012-2013), Arianna Chiti (2018-2020), Rose McKeon (The Genetics Society Summer Studentship, 1600 GBP; 2019-2020), Erin Iffla (2020-2021), Daniel Leask (2020-2021), and Megan Reid (2020-2021), Hillary Yuen (2021-2022), Sara De Diego Herrera (2021-2022), Sophie Barker (2021-2022).
%\item {\bf Masters researchers}. Amanda Queiroz (Co-supervisor; Universidade Estadual Paulista; 2020-2021).
\item {\bf Doctoral researchers}. Adrian Bach (2018-2022), Th\'{e}o S. C. Pannetier (2020-2022), John H. Paterson (2020-2021), and Benjamin M. Marshall (2021-2025).
\end{itemize}

\section*{Leadership}
\begin{itemize}
\item {\bf Associate Editor}: Journal of Animal Ecology (2021-present)
\item {\bf Manuscript reviewer}: {\it Acta Oecologica}, {\it American Naturalist}, {\it Annals of Human Biology}, {\it Arthropod-Plant Interactions}, {\it Behavioral Ecology}, {\it Behavioral Ecology and Sociobiology}, {\it Biology Letters} (5), {\it BMC Evolutionary Biology}, {\it Ecology and Evolution} (4), {\it Ecological Complexity}, {\it Ecological Modelling} (2), {\it Environmental Conservation}, {\it Evolution} (6), {\it Evolutionary Ecology} (3), the {\it Journal of Animal Ecology}, the {\it Journal of Applied Ecology} (3), the {\it Journal of Theoretical Biology} (3), {\it Landscape Ecology}, {\it Molecular Ecology} (2), {\it Oikos} (4), {\it PLoS One}, {\it Proceedings of the National Academy of Sciences USA} (2), {\it Proceedings of the Royal Society B} (2), {\it Royal Society Open Science}, {\it Scientific Reports} (2), and {\it Symbiosis}
